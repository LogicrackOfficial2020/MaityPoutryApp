...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
       ...
       else if (Tag.equalsIgnoreCase("New2")) {
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.row_productgrid, parent, false);
        }
        else {
            itemView = LayoutInflater.from(parent.getContext())
...
//        holder.price.setText(product.getPrice());
    //    holder.currency.setText(product.getCurrency());
     //   holder.attribute.setText(product.getAttribute());
        ...
        {
            holder.shopNow.setText("Out of Stock");
        }

        holder.Discount_price.setPaintFlags(holder.Discount_price.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
       // "http://kitchenrefill.com/Admin/"+

        holder.Discount_price.setText("Market Price: " + "Rs." + ":" + product.getMarketPrice());
        ...
        holder.shopNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.shopNow.getText() != "Out of Stock") {
                    holder.shopNow.setVisibility(View.GONE);
                    holder.quantity_ll.setVisibility(View.VISIBLE);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView plus, minus, quantity,Discount_price;
        CardView cardView;
