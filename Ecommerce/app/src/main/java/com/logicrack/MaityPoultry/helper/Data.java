package com.logicrack.MaityPoultry.helper;

import com.logicrack.MaityPoultry.model.Category;
import com.logicrack.MaityPoultry.model.Offer;
...
public class Data {
    ...
    public List<Category> getCategoryList() {
        Category category = new Category("1", "Grocery", "https://thumbs.dreamstime.com/b/household-cleaning-products-accessories-basket-there-mop-detergents-rubber-gloves-glass-cleaner-sponges-89944820.jpg");
        categoryList.add(category);
        category = new Category("2", "Fruits", "https://lisasnatural.com/wp-content/uploads/2018/05/housecleanicon-300x228.jpg");
        categoryList.add(category);
        category = new Category("3", "Vegetables", "https://tips4tots.files.wordpress.com/2015/08/medical-insurance-free-icon.png");
        categoryList.add(category);
